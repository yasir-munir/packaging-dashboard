      ...
      <div>
        <ul class="navigation-left">
          ...
          <li
            ...
            || currentUserPermissions.includes('roll_generate')
      ...
      <div ref="sidebarChild">
        ...
        >
          ...
          <!-- <li
            ...
            v-if="currentUserPermissions && currentUserPermissions.includes('products_add')"
          >
            <router-link tag="a" class to="/app/products/store-roll">
              <i class="nav-icon i-Add-File"></i>
              <span class="item-name">{{$t('AddRoll')}}</span>
            </router-link>
          </li>
          <li
            class="nav-item"
            v-if="currentUserPermissions && currentUserPermissions.includes('products_add')"
          >
            <router-link tag="a" class to="/app/products/store-carton">
              <i class="nav-icon i-Add-File"></i>
