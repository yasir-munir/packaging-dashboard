...
export default {
    ...
    TaxInvoiceDownload: 'Sales Tax Download',
    GatePassGenerate: 'Generate Gate Pass',
    GatePass: 'Gate Pass',
    ...
    Delete: {
        ...
        ShadeDeleted: 'This Shade has been deleted.',
        GramDeleted: 'This Gramage has been deleted.',
        ReelDeleted: 'This Reel Size has been deleted.',
    ...
    Update: {
        ...
        TitleShade: 'Shade Updated in successfully',
        TitleGram: 'Grams Updated in successfully',
        TitleReel: 'Reel Size Updated in successfully',
    ...
    Create: {
        ...
        TitleShade: 'Shade Created in successfully',
        TitleGram: 'Gramage Created in successfully',
        TitleReel: 'Reel Size Created in successfully',
    ...
    vehicalNumber: 'Vehical No.',
    delivered_to:'Delivered To',
    shipment_ref:'Gate Pass Ref',
    sale_ref:'Sale Ref',
    ...
    Variant_dimension:'Dimensions',
    Variant_ply:'Ply',
    Variant_crafting: 'Crafting',
    Variant_Width:'Width',
    Variant_BF: 'BF',
    Variant_Top: 'Top',
    Variant_Flute: 'Flute',
    ...
    Variant_Paper_Grams:'Paper Grams',
    Variant_Paper_Type:'Paper Type',
    Variant_Paper_Shade:'Paper Shade',
