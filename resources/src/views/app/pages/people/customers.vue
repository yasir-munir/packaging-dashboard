<template>
  <div class="main-content">
          ...
          <b-row>
            ...
            <b-col md="6" sm="12">
                ...
                <b-form-input
                    ...
                    v-model="client.sales_tax_number"
    ...
    <b-modal ok-only size="lg" id="showDetails" :title="$t('CustomerDetails')">
      <b-row>
        <b-col lg="12" md="12" sm="12" class="mt-3">
          <table class="table table-striped table-md">
            <tbody>
              ...
              <tr>
                ...
                <th>{{client.person2}}</th>
                <!-- Customer Person 2 Phone 1-->
                <td>{{$t('Phone 1')}}</td>
                <th>{{client.phone1_p2}}</th>
              </tr>
              <tr>
                <!-- Customer Person 2 Phone 2 -->
                <td>{{$t('Phone 2')}}</td>
                <th>{{client.phone2_p2}}</th>
                <!-- Customer Email 2-->
                <td>{{$t('Email 2')}}</td>
                <th>{{client.email_p2}}</th>
              </tr>
              <tr>
                <!-- Contact Person 3 -->
                <td>{{$t('Contact Person 3')}}</td>
                <th>{{client.person3}}</th>
                <!-- Customer Person 3 Phone 1-->
                <td>{{$t('Phone 1')}}</td>
                <th>{{client.phone1_p3}}</th>
              </tr>
              <tr>
                <!-- Customer Person 3 Phone 2 -->
                <td>{{$t('Phone 2')}}</td>
                <th>{{client.phone2_p3}}</th>
                <!-- Customer Email 3-->
                <td>{{$t('Email 3')}}</td>
                <th>{{client.email_p3}}</th>
              </tr>
              <tr>
                <!-- Customer country -->
                <td>{{$t('Country')}}</td>
              ...
              <tr>
                ...
                <th>{{client.gl_acc_no}}</th>
                <!-- Sales Tax Number -->
                <td>{{$t('Sales Tax Number')}}</td>
                <th>{{client.sales_tax_number}}</th>
              </tr>
              <tr>
                <!-- Remarks -->
                <td>{{$t('Remarks')}}</td>
  ...
  methods: {
    ...
    clients_PDF() {
      ...
      let columns = [
        ...
        { title: "GL Account#", dataKey: "gl_acc_no" },
    ...
    Create_Client() {
      ...
      axios
        .post("clients", {
          ...
          person1: this.client.person1,
          phone2_p1: this.client.phone2_p1,
          person2: this.client.person2,
          email_p2: this.client.email_p2,
          phone1_p2: this.client.phone1_p2,
          phone2_p2: this.client.phone2_p2,
          person3: this.client.person3,
          email_p3: this.client.email_p3,
          phone1_p3: this.client.phone1_p3,
          phone2_p3: this.client.phone2_p3,
          sales_tax_number: this.client.sales_tax_number,
          state: this.client.state,
          remarks: this.client.remarks,
          status: this.client.status,
          gl_acc_no: this.client.gl_acc_no
        })
        .then(response => {
