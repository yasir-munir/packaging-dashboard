<template>
  <div class="main-content">
      ...
      <b-modal hide-footer size="lg" id="New_Provider" :title="editmode?$t('Edit'):$t('Add')">
        <b-form @submit.prevent="Submit_Provider">
          <b-row>
            ...
            <b-col md="6" sm="12">
                <b-form-group :label="$t('Person Name')">
                  <b-form-input
                    label="person"
                    v-model="provider.person1"
            ...
            <!-- Customer Phone 2-->
            <b-col md="6" sm="12">
                <b-form-group :label="$t('Phone 2')">
                  <b-form-input
                    label="Phone"
                    v-model="provider.phone2_p1"
            ...
            <!-- Customer Contact Name -->
            <b-col md="6" sm="12">
                <b-form-group :label="$t('2nd Person Name')">
                  <b-form-input
                    label="person2"
                    v-model="provider.person2"
                    :placeholder="$t('2nd Person Name')"
                  ></b-form-input>
                </b-form-group>
            </b-col>
            ...
            <!-- Customer Contact Name -->
            <b-col md="6" sm="12">
                <b-form-group :label="$t('3rd Person Name')">
                  <b-form-input
                    label="person3"
                    v-model="provider.person3"
                    :placeholder="$t('3rd Person Name')"
                  ></b-form-input>
                </b-form-group>
            </b-col>
            ...
            <b-col md="6" sm="12">
                <b-form-group :label="$t('Sales Tax Number')">
                <b-form-input
                    label="Sales Tax Number"
                    v-model="provider.sales_tax_number"
                    :placeholder="$t('Sales Tax Number')"
                ></b-form-input>
                </b-form-group>
            </b-col>
            ...
            <!-- Customer GL Account -->
            <b-col md="6" sm="12">
                <b-form-group :label="$t('GL Account Number')">
                  <b-form-input
                    label="GL Account Number"
                    v-model="provider.gl_acc_no"
                    :placeholder="$t('GL Account Number')"
                  ></b-form-input>
                </b-form-group>
            </b-col>
    ...
    <b-modal ok-only size="lg" id="showDetails" :title="$t('SupplierDetails')">
      <b-row>
        <b-col lg="12" md="12" sm="12" class="mt-3">
          <table class="table table-striped table-md">
            <tbody>
              ...
              <tr>
                <!-- Contact Person 2 -->
                <td>{{$t('Contact Person 2')}}</td>
                <th>{{provider.person2}}</th>
                <!-- Customer Person 2 Phone 1-->
                <td>{{$t('Phone 1')}}</td>
                <th>{{provider.phone1_p2}}</th>
              </tr>
              <tr>
                <!-- Customer Person 2 Phone 2 -->
                <td>{{$t('Phone 2')}}</td>
                <th>{{provider.phone2_p2}}</th>
                <!-- Customer Email 2-->
                <td>{{$t('Email 2')}}</td>
                <th>{{provider.email_p2}}</th>
              </tr>
              <tr>
                <!-- Contact Person 3 -->
                <td>{{$t('Contact Person 3')}}</td>
                <th>{{provider.person3}}</th>
                <!-- Customer Person 3 Phone 1-->
                <td>{{$t('Phone 1')}}</td>
                <th>{{provider.phone1_p3}}</th>
              </tr>
              <tr>
                <!-- Customer Person 3 Phone 2 -->
                <td>{{$t('Phone 2')}}</td>
                <th>{{provider.phone2_p3}}</th>
                <!-- Customer Email 3-->
                <td>{{$t('Email 3')}}</td>
                <th>{{provider.email_p3}}</th>
              </tr>
              <tr>
                <!-- Customer country -->
                <td>{{$t('Country')}}</td>
              ...
              <tr>
                <!-- GL Account Number -->
                <td>{{$t('GL Account Number')}}</td>
                <th>{{provider.gl_acc_no}}</th>
                <!-- Sales Tax Number -->
                <td>{{$t('Sales Tax Number')}}</td>
                <th>{{provider.sales_tax_number}}</th>
              </tr>
              <tr>
                <!-- Remarks -->
                <td>{{$t('Remarks')}}</td>
                <th>{{provider.remarks}}</th>
              </tr>
              <tr>
                <!-- Total_Purchase_Due -->
    ...
    Create_Provider() {
      ...
      axios
        .post("providers", {
          ...
          person1: this.provider.person1,
          phone2_p1: this.provider.phone2_p1,
          person2: this.provider.person2,
          email_p2: this.provider.email_p2,
          phone1_p2: this.provider.phone1_p2,
          phone2_p2: this.provider.phone2_p2,
          person3: this.provider.person3,
          email_p3: this.provider.email_p3,
          phone1_p3: this.provider.phone1_p3,
          phone2_p3: this.provider.phone2_p3,
          sales_tax_number: this.provider.sales_tax_number,
          state: this.provider.state,
          remarks: this.provider.remarks,
          status: this.provider.status,
          gl_acc_no: this.provider.gl_acc_no
        })
        .then(response => {
