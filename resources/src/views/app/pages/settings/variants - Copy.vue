...
<div class="main-content">
    ...
    <b-card class="wrapper" v-if="!isLoading">
        <vue-good-table mode="remote" :columns="columns" :totalRows="totalRows" :rows="variants" @on-page-change="onPageChange" @on-per-page-change="onPerPageChange" @on-sort-change="onSortChange" @on-search="onSearch" :search-options="{
        enabled: true,
                ...
                <b-row>
                    ...
                    <b-col md="12">
                        <validation-provider name="Variant Name" :rules="{ required: true}" v-slot="validationContext">
                            <b-form-group :label="$t('VarName')">
                                <b-form-input :placeholder="$t('Enter_variant_name')" :state="getValidationState(validationContext)" aria-describedby="Code-feedback" label="Code" v-model="variant.v_name"></b-form-input>
                    ...
                    <b-col md="12">
                        <validation-provider name="Variant Cost" :rules="{ required: true}" v-slot="validationContext">
                            <b-form-group :label="$t('VarCost')">
                                <b-form-input :placeholder="$t('Enter_variant_cost')" :state="getValidationState(validationContext)" aria-describedby="Name-feedback" label="Name" v-model="variant.v_cost"></b-form-input>
                    ...
                    <b-col md="12">
                        <validation-provider name="Variant Price" :rules="{ required: true}" v-slot="validationContext">
                            <b-form-group :label="$t('VarPrice')">
                                <b-form-input :placeholder="$t('Enter_variant_price')" :state="getValidationState(validationContext)" aria-describedby="Name-feedback" label="Name" v-model="variant.v_price"></b-form-input>
                                <b-form-invalid-feedback id="Name-feedback">{{ validationContext.errors[0] }}</b-form-invalid-feedback>
                            </b-form-group>
                        </validation-provider>
                    </b-col>
...
export default {
    ...
    computed: {
        columns() {
            return [{
                    label: this.$t("VarName"),
                    field: "v_name",
                    tdClass: "text-left",
                    thClass: "text-left"
                },
                {
                    label: this.$t("VarCost"),
                    field: "v_cost",
                    tdClass: "text-left",
                    thClass: "text-left"
                },
                {
                    label: this.$t("VarPrice"),
                    field: "v_price",
                    tdClass: "text-left",
                    thClass: "text-left"
                },
        ...
        delete_by_selected() {
            this.$swal({
                ...
                if (result.value) {
                    ...
                    NProgress.set(0.1);
                    axios
                        .post("variants/delete/by_selection", {
