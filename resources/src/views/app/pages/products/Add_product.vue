            ...
            <b-card class="mt-3">
              <b-row>
                ...
                <div class="col-md-9 mb-3 mt-3" v-if="product.type == 'is_variant'">
                    <div class="d-flex">
                      <legend tabindex="-1" class="bv-no-focus-ring col-form-label pt-0" id="__BVID__141__BV_label_">Variant Details</legend>
                    </div>
                  <div class="d-flex">
                    <input
                      style="height: 40px;"
                      ...
                      <table class="table table-hover table-sm">
                        ...
                        <tbody>
                          ...
                          <tr v-for="variant in variants">
                            ...
                            <td>
                              <input required class="form-control" v-model="variant.crafting">
                            </td>
                            <td>
                              <input required class="form-control" v-model="variant.paperGram">
                            </td>
                      ...
                      <table class="table table-hover table-sm">
                        ...
                        <tbody>
                          ...
                          <tr v-for="variant in variants">
                            ...
                            <td>
                              <input required class="form-control" v-model="variant.dimension">
                            </td>
                            <td>
                              <input required class="form-control" v-model="variant.ply">
                            </td>
                            <td>
                              <input required class="form-control" v-model="variant.paperGram">
                            </td>
