...
class ClientController extends BaseController
{
    ...
    public function index(request $request)
    {
        ...
        foreach ($clients as $client) {
            ...
            $item['person1'] = $client->person1;
            $item['phone'] = $client->phone;
            $item['phone2_p1'] = $client->phone2_p1;
            $item['email'] = $client->email;

            $item['person2'] = $client->person2;
            $item['phone1_p2'] = $client->phone1_p2;
            $item['phone2_p2'] = $client->phone2_p2;
            $item['email_p2'] = $client->email_p2;

            $item['person3'] = $client->person3;
            $item['phone1_p3'] = $client->phone1_p3;
            $item['phone2_p3'] = $client->phone2_p3;
            $item['email_p3'] = $client->email_p3;

            $item['sales_tax_number'] = $client->sales_tax_number;
            $item['state'] = $client->state;
            $item['remarks'] = $client->remarks;
            $item['status'] = $client->status;
            $item['gl_acc_no'] = $client->gl_acc_no;
